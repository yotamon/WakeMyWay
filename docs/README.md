...
Read `08`, `10`, `17`, `18`, then ADRs `002`, `009`, `011`.

### Wake behavior work

Read `04`, `05`, `11`, `14`, then ADRs `003`, `005`.
...
| [`31-pre-implementation-architecture-review.md`](31-pre-implementation-architecture-review.md) | Applied architecture review and rationale before M0 |
...
| [`22-product-metrics-experiments.md`](22-product-metrics-experiments.md) | Wake Success, friction, experiments |
...
| [`05-ux-flows.md`](05-ux-flows.md) | Night/morning flows and wake interaction |
...
| [`09-stack-and-dependencies.md`](09-stack-and-dependencies.md) | Adopt-by-milestone technology strategy |
| [`10-alarm-kernel.md`](10-alarm-kernel.md) | Deep Alarm Kernel contract / Direct Boot / scheduling |
| [`11-wake-runtime-state-machine.md`](11-wake-runtime-state-machine.md) | Deep deterministic Wake Runtime |
| [`12-data-model.md`](12-data-model.md) | Local source-of-truth model / critical snapshot |
| [`13-ai-voice-character-system.md`](13-ai-voice-character-system.md) | Speech Intent, character, measured voice spike |
| [`14-wake-strategy-learning.md`](14-wake-strategy-learning.md) | Wake Policy / off-session Wake Learning |
| [`15-context-calendar-weather.md`](15-context-calendar-weather.md) | Optional context constraints |
| [`20-api-backend.md`](20-api-backend.md) | Deferred backend/API direction |
...
| [`17-reliability-failure-modes.md`](17-reliability-failure-modes.md) | Reliability envelope/graceful degradation |
| [`18-testing-quality.md`](18-testing-quality.md) | Contract tests, Direct Boot/Force Stop/device testing |
| [`19-observability-analytics.md`](19-observability-analytics.md) | Safe semantic telemetry / reliability metrics |
| [`25-open-source-and-licenses.md`](25-open-source-and-licenses.md) | Dependency/model licensing policy |
| [`32-testing-and-deployment-topology.md`](32-testing-and-deployment-topology.md) | Testing ladder, Firebase/Play distribution, Vercel cloud topology |

## Delivery

| Document | Purpose |
|---|---|
| [`21-roadmap-implementation-plan.md`](21-roadmap-implementation-plan.md) | Evidence-driven M0–M12 build order |
| [`implementation/backlog.md`](implementation/backlog.md) | Seed issue backlog |
...
| [`research/android-alarm-platform.md`](research/android-alarm-platform.md) | Time-sensitive Android alarm/Direct Boot/Force Stop/platform facts |
